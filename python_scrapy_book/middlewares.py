...
class PythonScrapyBookSpiderMiddleware:
    ...
    def process_start_requests(self, start_requests, spider):
        ...
        # similarly to the process_spider_output() method, except that it does not have a response associated.
...
class PythonScrapyBookDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
